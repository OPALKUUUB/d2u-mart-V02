  ...
  return (
    <section style={{ backgroundColor: "#e6e5e1" }}>
      ...
      <div className=" relative w-full flex flex-col items-center py-5 pr-0 lg:pr-[280px] xl:pr-[400px]">
        <img
          src="/image/side.png"
          className="absolute hidden xl:flex right-0 w-[160px] h-full object-cover top-0"
          alt=""
        />
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 w-full max-w-fit 2xl:max-w-[1100px] justify-items-ce gap-y-6 gap-x-4 relative py-[40px]">
          <p
            className="absolute mb-0 top-0 left-7 hover:text-[#718275] ease-linear duration-500 underline cursor-pointer"
          ...
          <img
            ...
            className="absolute hidden lg:flex top-[55px] -right-[300px] 2xl:-right-[280px] "
            alt=""
          />
