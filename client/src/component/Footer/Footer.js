...
function Footer() {
  return (
    <>
      <div className="w-full flex justify-end bg-[#fef1e7]">
        <div className="w-full flex flex-col items-center px-20 py-[30px] gap-8">
          <div className="w-full max-w-[700px] flex flex-col justify-start gap-1">
            <p className="font-[600] text-[24px]">ติดต่อเรา</p>
            <div className="w-full flex flex-wrap items-center gap-[30px] text-[20px]">
          ...
          <div className="w-full max-w-[700px] flex flex-col justify-start gap-1">
            ...
            <div className="w-full flex items-center gap-[30px] text-[20px]">
              <p className="mb-0">เวลาทำการ ทุกวัน 08:00-22:30 น.</p>
            </div>
          </div>
        </div>
        <img
          className="w-[180px] h-full max-h-[270px] object-cover"
          src="/image/side.png"
          alt=""
        />
      </div>
