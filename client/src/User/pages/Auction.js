  ...
  return (
    ...
    >
      ...
      <Row className="justify-content-md-center">
        <Col md={4}>
          <Figure onClick={() => history.push("/auction/yahoo")}>
        ...
        <Col md={4}>
          <Figure onClick={() => history.push("/auction/yahoo/order")}>
      ...
      <Row className="justify-content-md-center">
        <Col md={4}>
          <Figure onClick={() => history.push("/auction/yahoo/payment")}>
        ...
        <Col md={4}>
          <Figure onClick={() => history.push("/auction/yahoo/history")}>
